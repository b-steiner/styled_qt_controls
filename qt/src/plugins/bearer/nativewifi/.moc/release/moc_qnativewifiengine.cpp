...
struct qt_meta_stringdata_QNativeWifiEngine_t {
    QByteArrayData data[6];
    char stringdata0[69];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QNativeWifiEngine_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QNativeWifiEngine_t qt_meta_stringdata_QNativeWifiEngine = {
    {
QT_MOC_LITERAL(0, 0, 17), // "QNativeWifiEngine"
QT_MOC_LITERAL(1, 18, 12), // "scanComplete"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 11), // "closeHandle"
QT_MOC_LITERAL(4, 44, 10), // "initialize"
QT_MOC_LITERAL(5, 55, 13) // "requestUpdate"

    },
    "QNativeWifiEngine\0scanComplete\0\0"
    "closeHandle\0initialize\0requestUpdate"
};
...
const QMetaObject QNativeWifiEngine::staticMetaObject = {
    { &QBearerEngineImpl::staticMetaObject, qt_meta_stringdata_QNativeWifiEngine.data,
      qt_meta_data_QNativeWifiEngine,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QNativeWifiEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QNativeWifiEngine.stringdata0))
